  ...
  return (
    <>
      <div className="h-screen w-screen ">
        ...
        <h2 className="text-white p-3 mt-4">Find a frenchie...</h2>
        ...
        >
          <img src={frenchImg} alt="" className="p-3" />
        </motion.div>
        ...
        <p className="mx-3 text-white mt-4 leading-8" ref={ref3}>
          ...
          frenchies they are my children so I don’t believe in forced breeding.
          It’s totally up to my females whether they choose to mate or not. All
          of our babies get plenty of love and attention in our home. We have 7
          children but 5 still at home. Our frenchies are super spoiled! Our
          babies are vet checked & given the shots needed to go to their FUREVER
          home! I do have both parents at my home available for viewing as well.
          If your in need of a perfect companion then look no further!❤️🐾
        </p>
        ...
        <motion.div
          ...
          transition={{ ease: "easeOut", duration: 2 }}
        >
          <img src={womanImg} alt="" className="p-3 mt-4" />
        </motion.div>
